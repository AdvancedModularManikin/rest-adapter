...
const std::string moduleName = "AMM_REST_Bridge";
const std::string configFile = "config/rest_bridge_amm.xml";
...
void PublishOperationalDescription() {
   ...
   const std::string capabilities = AMM::Utility::read_file_to_string("config/rest_bridge_capabilities.xml");
...
void PublishConfiguration() {
   ...
   mc.module_id(m_uuid);
   mc.name(moduleName);
   const std::string configuration = AMM::Utility::read_file_to_string("config/rest_bridge_configuration.xml");
