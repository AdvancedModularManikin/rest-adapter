...
JsonUtils::ParseException::ParseException(const std::string& message)
		: std::runtime_error("JSON parse error: " + message) {}

rapidjson::Document JsonUtils::parseJson(const std::string& json) {
...
std::string JsonUtils::serializeAction(const Action& action) {
...
std::string JsonUtils::serializeActions(const std::vector<Action>& actions) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
Action JsonUtils::parseAction(const std::string& json) {
...
std::string JsonUtils::serializeModule(const Module& module) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::serializeModules(const std::vector<Module>& modules) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::serializeModuleCounts(const ModuleCounts& counts) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::serializeModuleNames(const std::vector<std::string>& moduleNames) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::serializeEventLog(const std::vector<EventLogEntry>& events) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::escapeCSV(const std::string& str) {
...
std::string JsonUtils::createEventLogCSV(const std::vector<EventLogEntry>& events) {
...
std::string JsonUtils::serializeDiagnosticLog(const std::vector<DiagnosticLogEntry>& logs) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::createDiagnosticLogCSV(const std::vector<DiagnosticLogEntry>& logs) {
	std::ostringstream csv;
...
std::string JsonUtils::serializeError(const std::string& message, const std::string& details) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::serializeError(const std::string& message,
...
std::string JsonUtils::serializeAssessment(const Assessment& assessment) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::serializeAssessments(const std::vector<Assessment>& assessments) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
Assessment JsonUtils::parseAssessment(const std::string& json) {
	auto doc = parseJson(json);
...
PerformanceAssessmentData JsonUtils::parsePerformanceAssessment(const std::string& json) {
	auto doc = parseJson(json);
...
std::string JsonUtils::serializeStatus(const std::map<std::string, std::string>& status) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::serializeKeyValue(const std::string& key, const std::string& value) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::serializeKeyValue(const std::string& key, double value) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
std::string JsonUtils::serializeNodesAndStatus(
...
std::string JsonUtils::serializeInstance(const InstanceInfo& instance) {
	rapidjson::StringBuffer buffer;
	rapidjson::Writer<rapidjson::StringBuffer> writer(buffer);
...
PhysiologyModification JsonUtils::parsePhysiologyModification(const std::string& json) {
	auto doc = parseJson(json);
...
RenderModification JsonUtils::parseRenderModification(const std::string& json) {
	auto doc = parseJson(json);
